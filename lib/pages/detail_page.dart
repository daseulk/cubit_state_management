                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          AppLargeText(text: detail.place.name, size: 25, color: Colors.black.withOpacity(0.8)),
                          AppLargeText(text: '\$' + detail.place.price.toString(), size: 25, color: AppColors.mainColor)
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 10),
                          AppText(text: detail.place.stars.toDouble().toString(), color: AppColors.textColor2),
                        ],
                      ),
